...
{
	public class IsLowerOrEqualToFilter<TVal>: ColumnFilter, IIsLowerOrEqualToFilter<TVal>
	{

		public IsLowerOrEqualToFilter(IColumn Column,TVal Value):base(Column,Value)
		{
