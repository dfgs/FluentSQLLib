...
{
	public class IsGreaterOrEqualToFilter: ColumnFilter, IIsGreaterOrEqualToFilter
	{
		public IsGreaterOrEqualToFilter(IColumn Column,object Value):base(Column,Value)
		{
